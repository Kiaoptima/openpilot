...
class CarInterface(CarInterfaceBase):
  ...
  def update(self, c, can_strings):
    ...
    # some Optima only has blinker flash signal, changed and to or before timer
    if self.CP.carFingerprint == CAR.OPTIMA:
      ret.leftBlinker = bool(self.CS.left_blinker_flash or self.CS.prev_left_blinker or self.CC.turning_signal_timer)
      ret.rightBlinker = bool(self.CS.right_blinker_flash or self.CS.prev_right_blinker or self.CC.turning_signal_timer)

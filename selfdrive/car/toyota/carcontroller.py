...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, hud_alert,
    ...
    if CS.CP.enableGasInterceptor and enabled and CS.out.vEgo < MIN_ACC_SPEED and apply_accel * CarControllerParams.ACCEL_SCALE > coast_accel(CS.out.vEgo):
      ...
      apply_gas = clip(compute_gb_pedal(clip(apply_accel * CarControllerParams.ACCEL_SCALE, CarControllerParams.ACCEL_MIN, CarControllerParams.ACCEL_MAX), CS.out.vEgo), 0., 1.)
      apply_accel += 0.06
